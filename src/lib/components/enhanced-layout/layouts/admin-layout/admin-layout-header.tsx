...
const AdminLayoutHeader: FCWithoutChildren<AdminLayoutHeaderProps> = ({
  logoMobile,
  headerRight,
  sidebarWidth,
  ...
  const { mobileNavOpen, setMobileNavOpen, sidebarCollapsed, setSidebarCollapsed } = useAdminLayoutContext()
